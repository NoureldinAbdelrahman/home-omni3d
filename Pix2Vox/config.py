...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH    = './datasets/OmniObject3D/OmniObject3D.json'
# __C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH  = './datasets/PascalShapeNet.json'
__C.DATASETS.SHAPENET.RENDERING_PATH        = './datasets/OmniObject3D/OmniObjectRendering/%s/%s/rendering/%02d.png'
# __C.DATASETS.SHAPENET.RENDERING_PATH      = '/home/hzxie/Datasets/ShapeNet/PascalShapeNetRendering/%s/%s/render_%04d.jpg'
__C.DATASETS.SHAPENET.VOXEL_PATH            = './datasets/OmniObject3D/OmniObjectVox32/%s/%s/model.mat'
